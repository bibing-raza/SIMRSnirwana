...
public class DlgSetNota extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbYesNomorAntrian = new widget.ComboBox();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(44, 467));
        ...
        jLabel48.setText("Auto Print Nomor Antrian Pendaftaran Rawat Jalan :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(285, 432, 300, 23);

        cmbYesNomorAntrian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Yes", "No" }));
        cmbYesNomorAntrian.setName("cmbYesNomorAntrian"); // NOI18N
        cmbYesNomorAntrian.setPreferredSize(new java.awt.Dimension(55, 28));
        cmbYesNomorAntrian.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbYesNomorAntrianKeyPressed(evt);
            }
        });
        FormInput.add(cmbYesNomorAntrian);
        cmbYesNomorAntrian.setBounds(588, 432, 70, 23);
        ...
        if(TabSetting.getSelectedIndex()==0){
            if(NotaRalan.getText().trim().equals("")||KwitansiRalan.getText().trim().equals("")||Nota1Ranap.getText().trim().equals("")||Nota2Ranap.getText().trim().equals("")||
                ...
                if(Sequel.menyimpantf("set_nota","'"+NotaRalan.getText()+"','"+KwitansiRalan.getText()+"','"+Nota1Ranap.getText()+"',"+
                        ...
                        "'"+cmbYesTombolNotaPenjualanToko.getSelectedItem()+"','"+cmbYesNomorAntrian.getSelectedItem()+"'","Set Nota")==true){
                    tampil();
                    emptTeks();
                }                
            }else if(tabMode.getRowCount()>0){
...
private void NotaRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NotaRalanKeyPressed
    ...
    private void cmbYesNomorAntrianKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbYesNomorAntrianKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbYesNomorAntrianKeyPressed
    ...
    */
    ...
    private widget.ComboBox cmbYesNomorAntrian;
        ...
        try{    
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{" Auto Print Nomor Antrian Pendaftaran Rawat Jalan",rs.getString(29)});
                }
            } catch (Exception e) {
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            cmbYesNomorAntrian.setSelectedItem(tbAdmin.getValueAt(28,1).toString());
        }
    }
    ...
    public void emptTeks() {
        ...
        cmbYesNomorAntrian.setSelectedItem("No");
        NotaRalan.requestFocus();
    }

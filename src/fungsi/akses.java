...
public final class akses {
    ...
    private static String kode = "", kdbangsal = "", alamatip = "", namars = "", alamatrs = "", kabupatenrs = "", propinsirs = "", kontakrs = "", emailrs = "", form = "", namauser = "", kode_ppk = "",
            jenisLoket = "", nomorLoket = "", nomorAntrian = "";
    ...
    public static Timer tRefreshAntri;
    ...
    public static void setNomorAntrian(String nomorantri) {
        nomorAntrian = nomorantri;
    }
    
    public static String getNomorAntrian() {
        return akses.nomorAntrian;
    }

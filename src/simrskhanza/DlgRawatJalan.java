...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnMulai = new widget.Button();
        BtnAkhir = new widget.Button();
        TverifMulai = new widget.Label();
        TverifAkhir = new widget.Label();
        ...
        BtnMulai.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/checked.png"))); // NOI18N
        BtnMulai.setMnemonic('D');
        BtnMulai.setText("Waktu Mulai Layanan Poliklinik");
        BtnMulai.setToolTipText("Alt+D");
        BtnMulai.setGlassColor(new java.awt.Color(0, 153, 255));
        BtnMulai.setName("BtnMulai"); // NOI18N
        BtnMulai.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnMulai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMulaiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnMulai);
        BtnMulai.setBounds(920, 10, 220, 28);

        BtnAkhir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/checked.png"))); // NOI18N
        BtnAkhir.setMnemonic('D');
        BtnAkhir.setText("Waktu Akhir Layanan Poliklinik");
        BtnAkhir.setToolTipText("Alt+D");
        BtnAkhir.setGlassColor(new java.awt.Color(255, 153, 0));
        BtnAkhir.setName("BtnAkhir"); // NOI18N
        BtnAkhir.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnAkhir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAkhirActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnAkhir);
        BtnAkhir.setBounds(920, 47, 220, 28);

        TverifMulai.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        TverifMulai.setText("Pukul : -");
        TverifMulai.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TverifMulai.setName("TverifMulai"); // NOI18N
        panelGlass12.add(TverifMulai);
        TverifMulai.setBounds(1150, 10, 140, 23);

        TverifAkhir.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        TverifAkhir.setText("Pukul : -");
        TverifAkhir.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TverifAkhir.setName("TverifAkhir"); // NOI18N
        panelGlass12.add(TverifAkhir);
        TverifAkhir.setBounds(1150, 47, 140, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-10-2024" }));
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnMulaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMulaiActionPerformed
        Sequel.mengedit("antrol_bpjs", "no_rawat='" + TNoRw.getText() + "'", "jam_periksa_perawat='" + Sequel.cariIsi("select time(now())") + "'");
        TverifMulai.setText("Pukul : " + Sequel.cariIsi("select jam_periksa_perawat from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'"));
        TverifAkhir.setText("Pukul : " + Sequel.cariIsi("select jam_periksa_dokter from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'"));
    ...
    private void BtnAkhirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAkhirActionPerformed
        if (Sequel.cariInteger("select count(-1) from pemeriksaan_ralan where no_rawat='" + TNoRw.getText() + "'") > 0) {
            if (Sequel.cariIsi("select jam_periksa_perawat from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'").equals("00:00:00")) {
                JOptionPane.showMessageDialog(null, "Silahkan klik dulu tombol waktu mulai layanan poliklinik..!!!");
                BtnMulai.requestFocus();
            } else if (Sequel.cariInteger("SELECT time_to_sec(TIMEDIFF(TIME(NOW()), jam_periksa_perawat)) FROM antrol_bpjs WHERE no_rawat='" + TNoRw.getText() + "'") <= 60) {
                JOptionPane.showMessageDialog(null, "Waktu akhir layanan poliklinik masih kurang semenit dari jam saat   \n"
                        + "petugas memeriksa pasien, tunggu beberapa saat & ulangi lagi..!!!");
            } else {
                Sequel.mengedit("antrol_bpjs", "no_rawat='" + TNoRw.getText() + "'", "jam_periksa_dokter='" + Sequel.cariIsi("select time(now())") + "'");
                TverifMulai.setText("Pukul : " + Sequel.cariIsi("select jam_periksa_perawat from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'"));
                TverifAkhir.setText("Pukul : " + Sequel.cariIsi("select jam_periksa_dokter from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'"));
            }
        } else {
            JOptionPane.showMessageDialog(null, "Silahkan isi dulu data pemeriksaan pasiennya..!!!");
        }
    ...
    */
    ...
    private widget.Button BtnAkhir;
    ...
    private widget.Button BtnMulai;
    ...
    private widget.Label TverifAkhir;
    private widget.Label TverifMulai;
    ...
    public void isCek(){
        ...
        //task id 3,4,5 antrian online bpjs
        if (Sequel.cariInteger("select count(-1) from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'") == 0) {

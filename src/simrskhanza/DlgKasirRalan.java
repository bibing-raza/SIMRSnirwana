...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnAntrolFarmasi = new javax.swing.JMenu();
        MnAwalRacikan = new javax.swing.JMenuItem();
        MnAwalNonRacikan = new javax.swing.JMenuItem();
        MnAkhir = new javax.swing.JMenuItem();
        ...
        MnAntrolFarmasi.setBackground(new java.awt.Color(255, 255, 254));
        MnAntrolFarmasi.setForeground(new java.awt.Color(50, 50, 50));
        MnAntrolFarmasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAntrolFarmasi.setText("Antrian Online Farmasi (BPJS)");
        MnAntrolFarmasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAntrolFarmasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnAntrolFarmasi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnAntrolFarmasi.setName("MnAntrolFarmasi"); // NOI18N
        MnAntrolFarmasi.setPreferredSize(new java.awt.Dimension(200, 26));

        MnAwalRacikan.setBackground(new java.awt.Color(255, 255, 254));
        MnAwalRacikan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAwalRacikan.setForeground(new java.awt.Color(50, 50, 50));
        MnAwalRacikan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAwalRacikan.setText("Waktu Mulai Layanan Resep RACIKAN");
        MnAwalRacikan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnAwalRacikan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnAwalRacikan.setName("MnAwalRacikan"); // NOI18N
        MnAwalRacikan.setPreferredSize(new java.awt.Dimension(250, 26));
        MnAwalRacikan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnAwalRacikanActionPerformed(evt);
            }
        });
        MnAntrolFarmasi.add(MnAwalRacikan);

        MnAwalNonRacikan.setBackground(new java.awt.Color(255, 255, 254));
        MnAwalNonRacikan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAwalNonRacikan.setForeground(new java.awt.Color(50, 50, 50));
        MnAwalNonRacikan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAwalNonRacikan.setText("Waktu Mulai Layanan Resep NON RACIKAN");
        MnAwalNonRacikan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnAwalNonRacikan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnAwalNonRacikan.setName("MnAwalNonRacikan"); // NOI18N
        MnAwalNonRacikan.setPreferredSize(new java.awt.Dimension(250, 26));
        MnAwalNonRacikan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnAwalNonRacikanActionPerformed(evt);
            }
        });
        MnAntrolFarmasi.add(MnAwalNonRacikan);

        MnAkhir.setBackground(new java.awt.Color(255, 255, 254));
        MnAkhir.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAkhir.setForeground(new java.awt.Color(50, 50, 50));
        MnAkhir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnAkhir.setText("Waktu Akhir Layanan Farmasi");
        MnAkhir.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnAkhir.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnAkhir.setName("MnAkhir"); // NOI18N
        MnAkhir.setPreferredSize(new java.awt.Dimension(250, 26));
        MnAkhir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnAkhirActionPerformed(evt);
            }
        });
        MnAntrolFarmasi.add(MnAkhir);

        jPopupMenu1.add(MnAntrolFarmasi);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2024" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2024" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnAwalRacikanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAwalRacikanActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            tbKasirRalan.requestFocus();
        } else if (Sequel.cariInteger("select count(-1) from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'") == 0) {
            JOptionPane.showMessageDialog(null, "Data antrian online untuk pasien ini tidak ditemukan...!!!");
            tbKasirRalan.requestFocus();
        } else {
            Sequel.mengedit("antrol_bpjs", "no_rawat='" + TNoRw.getText() + "'", 
                    "jam_ambil_antri_obat='" + Sequel.cariIsi("select time(now())") + "', jenisresep='racikan'");
            JOptionPane.showMessageDialog(null, "Waktu mulai layanan farmasi resep racikan berhasil diupdate...!!!");
        }
    }//GEN-LAST:event_MnAwalRacikanActionPerformed

    private void MnAkhirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAkhirActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, tabel masih kosong...!!!!");
            TCari.requestFocus();
        } else if (TNoRw.getText().trim().equals("")) {
            ...
            if (Sequel.cariIsi("select jam_ambil_antri_obat from antrol_bpjs where no_rawat='" + TNoRw.getText() + "'").equals("00:00:00")) {
                JOptionPane.showMessageDialog(null, "Silahkan klik dulu waktu mulai layanan farmasi..!!!");
            } else if (Sequel.cariInteger("SELECT time_to_sec(TIMEDIFF(TIME(NOW()), jam_ambil_antri_obat)) FROM antrol_bpjs WHERE no_rawat='" + TNoRw.getText() + "'") <= 60) {
                JOptionPane.showMessageDialog(null, "Waktu akhir layanan farmasi masih kurang semenit dari jam layanan   \n"
                        + "saat menerima resep, tunggu beberapa saat & ulangi lagi..!!!");
            } else {
                Sequel.mengedit("antrol_bpjs", "no_rawat='" + TNoRw.getText() + "'", "jam_dipanggil_antri_obat='" + Sequel.cariIsi("select time(now())") + "'");
                JOptionPane.showMessageDialog(null, "Waktu akhir layanan farmasi berhasil diupdate...!!!");
            }
        }
    }//GEN-LAST:event_MnAkhirActionPerformed

    private void MnAwalNonRacikanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAwalNonRacikanActionPerformed
        if (tabModekasir.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, tabel masih kosong...!!!!");
            TCari.requestFocus();
        } else if (TNoRw.getText().trim().equals("")) {
            ...
            Sequel.mengedit("antrol_bpjs", "no_rawat='" + TNoRw.getText() + "'", 
                    "jam_ambil_antri_obat='" + Sequel.cariIsi("select time(now())") + "', jenisresep='non racikan'");
            JOptionPane.showMessageDialog(null, "Waktu mulai layanan farmasi resep non racikan berhasil diupdate...!!!");
        }
    }//GEN-LAST:event_MnAwalNonRacikanActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnAkhir;
    private javax.swing.JMenu MnAntrolFarmasi;
    private javax.swing.JMenu MnAwalKeperawatan;
    private javax.swing.JMenu MnAwalMedis;
    private javax.swing.JMenuItem MnAwalNonRacikan;
    private javax.swing.JMenuItem MnAwalRacikan;
    ...
    private javax.swing.JMenuItem MnPenilaianPreInduksi,MnHasilPemeriksaanUSGUrologi,MnHasilPemeriksaanUSGGynecologi,MnHasilPemeriksaanEKG,MnSudahTerbitSEP,MnPenatalaksanaanTerapiOkupasi,MnHasilPemeriksaanUSGNeonatus,
